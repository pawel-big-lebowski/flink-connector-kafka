...
public class LineageUtilTest {
    ...
    public void testDatasetsFromWithTopicList() {
        ...
        List<LineageDataset> datasets = LineageUtil.datasetsFrom(namespace, facets);

        assertThat(datasets).hasSize(2);
        assertThat(datasets.get(0).name()).isEqualTo("topic1");
        assertThat(datasets.get(0).namespace()).isEqualTo(namespace);
        assertThat(datasets.get(0).facets().get("facetName2")).isEqualTo(facet2);
        assertThat(datasets.get(0).facets().get("facetName3")).isEqualTo(facet3);

        assertThat(datasets.get(1).name()).isEqualTo("topic2");
        assertThat(datasets.get(1).namespace()).isEqualTo(namespace);
        assertThat(datasets.get(1).facets().get("facetName2")).isEqualTo(facet2);
        assertThat(datasets.get(1).facets().get("facetName3")).isEqualTo(facet3);
    }
